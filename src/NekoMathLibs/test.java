...
public class test {
    public static void main(String[] args){
        EquationTest.quadEqn(1.0, -5.0, 4.0);
        System.out.println();
        EquationTest.quadEqn(1.0, -2.0, 1.0);
        System.out.println();
        EquationTest.quadEqn(1.0, -5.0, 0);
        System.out.println();
        EquationTest.quadEqn(0, -5.0, 4.0);
        System.out.println();
        EquationTest.quadEqn(1.0, 0.0, 16.0);
        System.out.println();
        EquationTest.quadEqn(1.0, 3.0, 9.0);
        System.out.println();
        EquationTest.quadEqn(1.0, -6.0, 13.0);
        System.out.println();
